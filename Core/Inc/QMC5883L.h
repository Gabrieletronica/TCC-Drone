...
//extern void 				QMC5883L_readReg48Bit(struct VL53L0X* dev, uint8_t reg);
extern int 					QMC5883L_Read_Reg(uint8_t reg);
...
extern void 						QMC5883L_Read_Data(struct QMC5883L *dev,int16_t *MagX,int16_t *MagY,int16_t *MagZ);
extern void 						QMC5883L_Initialize(struct QMC5883L *dev,_qmc5883l_MODE MODE,_qmc5883l_ODR ODR,_qmc5883l_RNG RNG,_qmc5883l_OSR OSR);
...
extern uint16_t             QMC5883L_Azimuth(struct QMC5883L *dev);
